...
def parse_args():
    ...
    parser.add_argument(
        "--wandb", type=bool, default=False, help="wandb control flag (default: True)"
    )
    parser.add_argument(
        "--initial",
        type=str,
        default="MZ",
        help="write on your name initial to using wandb run name. (default: MZ)",
    )
...
def main():
    ...
    if args.wandb:
        wandb.init(project="competition_1", config=cfg)
        # set wnadb run name
